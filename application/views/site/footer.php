		...
		<div class="row" id="footer">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
					<address>
					  <strong>QUANG'S PERFUME SHOP</strong><br>
					  <span class="glyphicon glyphicon-home" aria-hidden="true"></span> Địa chỉ: Thọ Lộc - Thọ Xuân - Thanh Hoá<br>
					  <span class="glyphicon glyphicon-phone" aria-hidden="true"></span> Điện thoại: 0862828520<br>
					  Copyright ©2024 - Edit by Quang
					</address>
				</div>
				<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 text-right">
					<a href="https://www.fb.com/mnhqng.l" target="_blank"><img src="<?php echo base_url(); ?>upload/icon/facebook.png" alt=""></a>
					<a href="#"><img src="<?php echo base_url(); ?>upload/icon/twitter.png" alt=""></a>
					<a href="mailto:leminhquanglu4e@gmail.com"><img src="<?php echo base_url(); ?>upload/icon/google.png" alt=""></a>
				</div>
